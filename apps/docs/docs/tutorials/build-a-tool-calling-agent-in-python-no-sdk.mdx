...
[`weather_agent_rest.ipynb`](https://github.com/AcruxCore/AcruxCore/blob/main/scripts/tutorials/tool-calling-agent-in-python-no-sdk/notebook/weather_agent_rest.ipynb)
...
![New model dialog with public name llama-3.3-70b, credential OpenRouter, and upstream model meta-llama/llama-3.3-70b-instruct](/img/tutorials/build-a-tool-calling-agent-in-python-no-sdk/02-new-model.png)
...
![The py-weather-agent prompt Editor tab showing default model llama-3.3-70b, a system and user message, and production pointing at v1](/img/tutorials/build-a-tool-calling-agent-in-python-no-sdk/04-prompt-editor.png)
