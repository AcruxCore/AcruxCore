...
[`triage_system.ipynb`](https://github.com/AcruxCore/AcruxCore/blob/main/scripts/tutorials/trace-an-openai-agents-sdk-triage-system/notebook/triage_system.ipynb)
