...
You can also create tools through the [dashboard](../guides/create-a-tool) (no code), or declare them in code with [`acrux.tool`](../guides/create-a-tool) so the first run auto-registers them in the catalog.
:::
...
You can also author prompts in the [dashboard's visual editor](../guides/version-a-prompt), or declare tools in code with [`acrux.tool`](../guides/create-a-tool) and have the first run auto-create the prompt.
:::
