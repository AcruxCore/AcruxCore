...
<details>
<summary>Full source: <code>web_research_agent.sh</code></summary>
...
<details>
<summary>Full source: <code>web_research_agent.py</code></summary>
...
Run:
  ...
  export ACRUXCORE_BASE_URL=https://api.acruxcore.com/api/v1
  export TAVILY_API_KEY=tvly-...
  python web_research_agent.py quick "What are people saying about the new Anthropic Claude models?"
  python web_research_agent.py deep  "What are people saying about the new Anthropic Claude models?"
"""
...
from 10 search results instead of 5. Nothing in `web_research_agent.py` branches on
...
<details>
<summary>Full source: <code>web_research_agent.mjs</code></summary>

```javascript
/**
 * Configurable web-research agent — Node, the SDK's runToolLoop(), over the
 * gateway. Same shape as web_research_agent.py: the whole configuration swap is
 ...
 *   export ACRUXCORE_BASE_URL=https://api.acruxcore.com/api/v1
 *   export TAVILY_API_KEY=tvly-...
 *   node web_research_agent.mjs quick "What are people saying about the new Anthropic Claude models?"
 *   node web_research_agent.mjs deep  "What are people saying about the new Anthropic Claude models?"
 */
