...
![The search_docs tool page marked "Defined in code", with v2 carrying the production chip and v1 the staging chip, both versions tagged as coming from code](/img/tutorials/build-a-rag-agent-without-the-gateway/06-tool-catalog.png)
