...
[`acrux_rag.ipynb`](https://github.com/AcruxCore/AcruxCore/blob/main/scripts/tutorials/rag-agent-without-the-gateway/notebook/acrux_rag.ipynb)
...
![The rag-linear trace showing 2 spans and 1,771 tokens: a Retrieval span named search_docs at 869ms, then an LLM span for google/gemini-3.7-flash at 3.56s](/img/tutorials/build-a-rag-agent-without-the-gateway/03-linear-trace.png)

Expand the LLM span and the BYO call is fully accounted for — tokens, latency, and `openrouter.ai` as the provider:

![The expanded LLM span showing Model google/gemini-3.7-flash, Provider openrouter.ai, Tokens 1,771, Latency 3.56s, and a "View traces for this prompt version" link](/img/tutorials/build-a-rag-agent-without-the-gateway/04-llm-span-detail.png)
...
![The rag-agentic trace showing 3 spans and 1,962 tokens: an LLM span at 2.05s, a nested Tool span named search_docs at 909ms, and a second LLM span at 3.92s](/img/tutorials/build-a-rag-agent-without-the-gateway/05-agentic-trace.png)
