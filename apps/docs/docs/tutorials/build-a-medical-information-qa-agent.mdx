...
[`medical_information_qa.ipynb`](https://github.com/AcruxCore/AcruxCore/blob/main/scripts/tutorials/medical-information-qa/notebook/medical_information_qa.ipynb)
...
```text
get_drug_profile: tool_id=585b3871-6347-4bbe-b92b-388d60b55e94 v1 committed=True
get_inquiry: tool_id=d8169234-0a0c-45b8-9014-dffaae100670 v1 committed=True
search_prescribing_info: tool_id=f57c937c-3dd1-481a-863f-9336cfa42abb v1 committed=True
check_safety_policy: tool_id=5ff86cac-a065-45b4-b636-fa592baea46e v1 committed=True
```
...
yet — needs one more move on v2's row, under **Point here…**, to actually go live. Once it does, this
...
```text
check_safety_policy: tool_id=5ff86cac-a065-45b4-b636-fa592baea46e v4 committed=False
```
...
![The prompt's Tools tab with check_safety_policy, get_drug_profile, get_inquiry and search_prescribing_info connected, all in the default column that both aliases inherit](/img/tutorials/build-a-medical-information-qa-agent/07-prompt-attach-tools.png)
