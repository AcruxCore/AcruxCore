...
Open **Tools → get_weather** and it's there, with a **Defined in code**
badge:
...
[Create a tool](../guides/create-a-tool) for the dashboard walkthrough,
...
- [Version and track a tool](../guides/version-and-track-a-tool)
