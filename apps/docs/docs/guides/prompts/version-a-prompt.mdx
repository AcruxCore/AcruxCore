...
description: Create a prompt, commit versions, promote an alias to production, and render it from your app — the full prompt lifecycle in AcruxCore.
sidebar_position: 1
keywords: [prompt versioning, prompt alias, promote prompt, render prompt, prompt management]
slug: /guides/version-a-prompt
sidebar_label: Version and ship a prompt
---
...
- [Attach a tool](./create-a-tool) so the model can take actions.
