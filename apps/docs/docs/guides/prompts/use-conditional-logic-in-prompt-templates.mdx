...
description: Write Jinja2-style {% if %} conditionals and {% for %} loops inside a prompt template, rendered by AcruxCore's nunjucks-based engine.
sidebar_position: 2
keywords: [jinja2, nunjucks, prompt templating, conditional prompt, prompt loop, template variables]
slug: /guides/use-conditional-logic-in-prompt-templates
sidebar_label: Use conditional logic
---
