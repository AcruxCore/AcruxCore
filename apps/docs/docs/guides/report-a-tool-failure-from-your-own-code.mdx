...
- [Define a tool in code or in the catalog](./define-a-tool-in-code-or-in-the-catalog)
  — choosing between a tool your code runs and a tool AcruxCore runs.
- [Build and attach a tool](./build-and-attach-a-tool) — creating a tool in the
  catalog and giving a prompt access to it.
