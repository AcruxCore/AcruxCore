...
slug: /guides/evaluate-a-prompt-with-conversation-history
sidebar_label: Evaluate with conversation history
---
...
it forgot the last turn." AcruxCore reconstructs the prior turns of the flagged
