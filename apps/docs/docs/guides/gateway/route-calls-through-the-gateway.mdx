...
slug: /guides/route-calls-through-the-gateway
sidebar_label: Route calls through the gateway
---
...
Go to **Gateway → Credentials → New credential**. AcruxCore is **BYOK** — you
...
- Give the model actions to take: [create a tool](./create-a-tool).
...
- Wondering what routing through the gateway costs you: [full-cycle latency
  across six LLM-ops platforms](/blog/full-cycle-latency-benchmark), measured
  against real OpenAI and re-run four times to check how stable the number is.
