...
```typescript
const exported = await hub.prompts.exportVersion('77afb6c5-8146-4fde-96e3-493ef3751374', 1);
```
...
```python
exported = await hub.prompts.export_version('77afb6c5-8146-4fde-96e3-493ef3751374', 1)
```
